...
import OpcionesLab from './OptionLab';
...
function EditarHorario(props) {
    ...
    const editarHorario = async e => {
        ...
        const editarHorario = {
            nombreDoc: nuevoNombreDocente,
            materia: nuevaMateria,
            horarioini: nuevaHorainicio,
            horariofin: nuevaHorafin,
            laboratorio: labRef.current.value,
            ...
            >
                <div className="form-group">
                    ...
                    <input
                        ...
                        defaultValue={horario.nombreDoc}
                    />
                </div>
                ...
                <div className="form row">
                    <div className="form-group col-md-6">
                        ...
                        <input
                            ...
                            placeholder="Materia"
                            ref={horainicioRef}
                            defaultValue={horario.horarioini}
                        />
                    </div>
                    ...
                    <div className="form-group col-md-6">
                        ...
                        <input
                            ...
                            placeholder="Materia"
                            ref={horafinRef}
                            defaultValue={horario.horariofin}
                        />
                    </div>
                </div>
